...
// A cross-platform wrapper that uses BlurView on iOS and a translucent View on Android
const BlurWrapper = ({ style, children }) => {
  if (Platform.OS === "android") {
    // Fallback for Android (simulate blur with a translucent dark background)
    return (
                  ...
                  <View key={index} style={styles.hubCard}>
                    ...
                    <View style={styles.hubCardContent}>
                      ...
                      <View style={styles.hubLocationContainer}>
                        ...
                        <Text style={styles.hubLocationText}>{item.location}</Text>
                      </View>
